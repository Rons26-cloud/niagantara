...
Create four Pages projects using Node 22 and pnpm 11.22.0. Build with `corepack pnpm --filter @niagantara/<web|dashboard|master|pos> build`; publish `apps/<app>/dist`. Configure `VITE_API_URL=https://api.niagantara.com/api/v1` and public release metadata.
